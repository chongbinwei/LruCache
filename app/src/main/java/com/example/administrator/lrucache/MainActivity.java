package com.example.administrator.lrucache;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean isQiaofeng = true;
        ...
        if (bitmap != null) {
            ...
            if(isQiaofeng){
                ...
                Resources res = getResources();
                 bm = BitmapFactory.decodeResource(res, R.drawable.test1);
                ...
                // 注：在添加到缓存前，需先将资源文件构造成1个BitMap对象（含设置大小）
                Resources res = getResources();
                 bm = BitmapFactory.decodeResource(res, R.drawable.test2);
                // 获得图片的宽高
                width = bm.getWidth();
                height = bm.getHeight();
...
//            }
     ...
     * 加载前，先从内存缓存中读取；若无，则再从数据源中读取
     **/
    public void loadBitmap2(String key, ImageView imageView) {
